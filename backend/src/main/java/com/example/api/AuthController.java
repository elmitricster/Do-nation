...
public class AuthController {
    ...
    @ApiOperation(value = "로그인", notes = "카카오 token을 사용하여 로그인을 시도합니다. 처음 로그인할 경우 회원가입을 자동으로 합니다.", response = TokenResponse.class)
    @GetMapping("/login")
...
//    }
    ...
    @ApiOperation(value = "유저 정보 업데이트", notes = "DB의 category, intro_message, user_nickname, profile_image, profile_name을 업데이트 합니다.", response = String.class)
    @PutMapping("/")
    ...
    @ApiOperation(value = "유저 닉네임 중복 확인", notes = "닉네임 중복 여부를 체크합니다.", response = String.class)
